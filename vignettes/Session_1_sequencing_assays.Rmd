...
```{r spatially-variable-genes-nnsvg, message=FALSE, warning=FALSE, eval=FALSE}
library(nnSVG)
...
```{r spatially-variable-genes-spatial-plot, fig.width=9, fig.height=7, eval=FALSE}
...
```{r spatially-variable-genes-umap-plot, fig.width=9, fig.height=7, eval=FALSE}
