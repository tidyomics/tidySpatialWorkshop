...
Useful complementary resource: the Bioconductor book [Orchestrating Spatial Transcriptomics Analysis with Bioconductor (OSTA)](https://bioconductor.org/books/release/OSTA/).
