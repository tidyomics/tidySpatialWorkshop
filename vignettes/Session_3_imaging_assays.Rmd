...
knitr::include_graphics(system.file("images/xenium.png", package = "tidySpatialWorkshop"))
```
...
```{r, echo=FALSE, out.width="700px"}
knitr::include_graphics(system.file("images/cosmx.png", package = "tidySpatialWorkshop"))
```
...
```{r, echo=FALSE, out.width="700px"}
knitr::include_graphics(system.file("images/merfish.png", package = "tidySpatialWorkshop"))
```
...
**Spatial-aware clustering:** Apply the spatial aware clustering method BANKSY. Taking as example the code run for Session 1.
:::
...
```{r}
plotTissue(tx_spe_sample_1, size = 0.5, color = perplexity) +
